...
namespace EducenAPI.Persistence.Migrations.AdminDb
{
    ...
    [Migration("20260330075605_AddTenantPaymentGatewayConfigEntities")]
    partial class AddTenantPaymentGatewayConfigEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EducenAPI.Models.TenantPaymentConfigAudit", b =>
                {
                    ...
                    b.HasIndex("TenantPaymentGatewayConfigId", "PerformedAt");

                    b.ToTable("TenantPaymentConfigAudits", null, t =>
                        {
                            t.HasCheckConstraint("CK_TenantPaymentConfigAudit_Action", "[Action] IN ('Create', 'Update', 'Submit', 'Approve', 'Reject', 'Activate', 'Deactivate', 'SoftDelete', 'Restore')");
                        });
                });
            ...
            modelBuilder.Entity("EducenAPI.Models.TenantPaymentGatewayConfig", b =>
                {
                    ...
                    b.HasIndex("TenantId", "GatewayType", "Status");

                    b.ToTable("TenantPaymentGatewayConfigs", null, t =>
                        {
                            t.HasCheckConstraint("CK_TenantPaymentGatewayConfig_Status", "[Status] IN ('Draft', 'PendingApproval', 'Active', 'Inactive', 'Rejected')");
                        });
                });
