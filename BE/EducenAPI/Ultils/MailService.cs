...
namespace EducenAPI.Ultils
{
    public class MailService
    {
        ...
        {
            var subject = $"[Báo cáo học tập] Tháng {month}/{year} - Học sinh {childName}";
            ...
            var body = $@"
                <div style='font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; color: #2d3748;'>
                    <div style='background: #6366f1; padding: 24px; color: white; border-radius: 8px 8px 0 0;'>
                        <h1 style='margin: 0; font-size: 20px;'>Báo cáo học tập tháng {month}/{year}</h1>
                        <p style='margin: 8px 0 0; opacity: 0.9;'>Học sinh: {childName}</p>
                    </div>
                    
                    <div style='padding: 24px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 8px 8px;'>
                        <p>Kính gửi phụ huynh <strong>{parentName}</strong>,</p>
                        <p>Trung tâm gửi đến bạn kết quả học tập của con em trong tháng {month}/{year} như sau:</p>
                        ...
                        <div style='display: flex; gap: 20px; margin: 24px 0; background: #f8fafc; padding: 16px; border-radius: 8px;'>
                            <div style='flex: 1; text-align: center;'>
                                ...
                                <div style='font-size: 12px; color: #718096; text-transform: uppercase;'>GPA Tổng</div>
                            </div>
                            <div style='flex: 1; text-align: center;'>
                                <div style='font-size: 24px; font-weight: bold; color: #10b981;'>{report.OverallAttendanceRate}%</div>
                                <div style='font-size: 12px; color: #718096; text-transform: uppercase;'>Chuyên cần</div>
                            </div>
                            <div style='flex: 1; text-align: center;'>
                                ...
                                <div style='font-size: 12px; color: #718096; text-transform: uppercase;'>Bài tập</div>
                            </div>
                        </div>
                        ...
                        <table style='width: 100%; border-collapse: collapse; margin-top: 20px;'>
                            <thead>
                                <tr style='background: #f1f5f9;'>
                                    <th style='padding: 12px; text-align: left; font-size: 13px;'>LỚP HỌC</th>
                                    <th style='padding: 12px; text-align: center; font-size: 13px;'>ĐIỂM DANH</th>
                                    <th style='padding: 12px; text-align: center; font-size: 13px;'>ĐIỂM TB</th>
                                    <th style='padding: 12px; text-align: center; font-size: 13px;'>XẾP LOẠI</th>
                                    <th style='padding: 12px; text-align: left; font-size: 13px;'>NHẬN XÉT</th>
                                </tr>
                            </thead>
                            <tbody>
                                {classRows}
                        ...
                        <div style='margin-top: 32px; padding-top: 24px; border-top: 1px solid #edf2f7; color: #718096; font-size: 14px;'>
                            <p>Bạn có thể đăng nhập vào hệ thống Educen để xem chi tiết điểm số từng bài tập và lịch sử điểm danh.</p>
                            <p>Trân trọng,<br/>Đội ngũ Educen.</p>
                        </div>
                    </div>
                </div>
            ";
