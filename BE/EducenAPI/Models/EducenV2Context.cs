...
public partial class EducenV2Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AsmId).HasName("PK__Assignme__8FEE6B2E559E68FF");
        ...
        {
            entity.HasKey(e => e.AssistantId).HasName("PK__Assistan__2A4E4C6579EF9EEC");
        ...
        {
            entity.HasKey(e => e.AttendanceId).HasName("PK__Attendan__20D6A9689411795F");
        ...
        {
            entity.HasKey(e => e.ClassId).HasName("PK__Class__FDF47986C2774D47");
        ...
        {
            entity.HasKey(e => e.GradeId).HasName("PK__Grade__3A8F732CC1AEE16C");

            entity.ToTable("Grade");

            entity.HasIndex(e => e.SubId, "UQ__Grade__694106B1D9AD2475").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaterialId).HasName("PK__Lesson_M__6BFE1D28902411AE");
        ...
        {
            entity.HasKey(e => e.ParentId).HasName("PK__Parent__F2A60819F37235E2");
            ...
            entity.HasMany(d => d.Students).WithMany(p => p.Parents)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ParentId", "StudentId").HasName("PK__Parent_S__40053870274541EB");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CC65356A4C");

            entity.ToTable("Role");

            entity.HasIndex(e => e.RoleName, "UQ__Role__783254B1AC308B46").IsUnique();
        ...
        {
            entity.HasKey(e => e.ScheduleId).HasName("PK__Schedule__C46A8A6FB71AC41B");
        ...
        {
            entity.HasKey(e => e.StudentId).HasName("PK__Student__2A33069A2578B632");
            ...
            entity.HasMany(d => d.Classes).WithMany(p => p.Students)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("StudentId", "ClassId").HasName("PK__Enrollme__55EC41026FB484B1");
        ...
        {
            entity.HasKey(e => e.SubjectId).HasName("PK__Subject__5004F660E342B89A");
        ...
        {
            entity.HasKey(e => e.SubId).HasName("PK__Submissi__694106B0088128B5");
        ...
        {
            entity.HasKey(e => e.TeacherId).HasName("PK__Teacher__03AE777E687D9DE8");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__B9BE370F1832793A");

            entity.ToTable("User");

            entity.HasIndex(e => e.Username, "UQ__User__F3DBC572ACEAB728").IsUnique();
